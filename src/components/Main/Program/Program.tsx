        ...
        <div className={styles.content}>
          ...
          >
            <div className={styles.heading}>
              <Image
                alt="program"
                src="/images/program/program1.webp"
                width={100}
                height={50}
              />
            ...
            <div className={styles.info}>
              <ul className={styles.list}>
                ...
                <li className={styles.item}>
                  Индивидуальный подбор количества повторений в подходе,
          ...
          >
            <div className={styles.heading}>
              <Image
                alt="program"
                src="/images/program/program2.jpg"
                width={100}
                height={50}
              />
            ...
            <div className={styles.info}>
              <ul className={styles.list}>
                ...
                <li className={styles.item}>
                  Разработка индивидуального плана применения спортивных
